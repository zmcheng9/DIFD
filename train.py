...
from models.fewshot_DIFD import FewShotSeg
...
def main(_run, _config, _log):
    ...
    log_loss = {'total_loss': 0, 'query_loss': 0, 'align_loss': 0, 'b_loss': 0, 'align_b_loss': 0}
    ...
    for sub_epoch in range(n_sub_epochs):
        ...
        for _, sample in enumerate(train_loader):
            ...
            query_pred, align_loss, align_b_loss = model(support_images, support_fg_mask, query_images, train=True)
            ...
            loss = query_loss + align_loss + b_loss + align_b_loss
            ...
            if (i_iter + 1) % _config['print_interval'] == 0:
                ...
                align_b_loss = log_loss['align_b_loss'] / _config['print_interval']

                log_loss['total_loss'] = 0
                log_loss['query_loss'] = 0
                log_loss['b_loss'] = 0
                log_loss['align_loss'] = 0
                log_loss['align_b_loss'] = 0

                _log.info(f'step {i_iter + 1}: total_loss: {total_loss}, query_loss: {query_loss}, b_loss: {b_loss}'
                          f' align_loss: {align_loss}, align_b_loss: {align_b_loss}')
